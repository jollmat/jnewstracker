    ...
    if (source.active) {
      switch(source.id) {
        ...
        case 'trescat': 
          ...
          break;
        case 'vilaweb': 
          const sourceVilawebEntity: NewsVilawebEntity = new NewsVilawebEntity(source, this.newstrackerService);
        ...
        case 'glamour': 
          ...
          source.news = sourceVogueEntity.news;
          break;
        case 'telva': 
          const sourceTelvaEntity: NewsTelvaEntity = new NewsTelvaEntity(source, this.newstrackerService);
        ...
        case 'fotogramas': 
          ...
          break;
        case 'espinof': 
          const sourceEspinofEntity: NewsEspinofEntity = new NewsEspinofEntity(source, this.newstrackerService);
